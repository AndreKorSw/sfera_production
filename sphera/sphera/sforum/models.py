...
class CompanyPost(models.Model):
    ...
    photo = models.ImageField(upload_to='photos/posts/%Y/%m/%d/', blank=False, verbose_name="Фото")
...
class Profile(models.Model):
    ...
    bio=models.TextField(verbose_name="О себе")#auto_created
    profile_pic=models.ImageField(upload_to='photos/profile_images/%Y/%m/%d/', null=True, blank=True, verbose_name="Фото профиля")
